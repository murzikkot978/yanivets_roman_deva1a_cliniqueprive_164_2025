...
def genres_afficher(order_by, id_genre_sel):
            ...
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """
                        SELECT m.id_medecin, m.nom_medecin, m.prenome_medecin, m.telephone, m.email, m.fk_specialite, s.nom_specialite
                        FROM t_medecin m
                        LEFT JOIN t_specialite s ON m.fk_specialite = s.id_specialite
                    """
                    ...
                    strsql_genres_afficher = """
                        ...
                        FROM t_medecin m
                        LEFT JOIN t_specialite s ON m.fk_specialite = s.id_specialite
                        WHERE m.id_medecin = %(value_id_genre_selected)s
                    """
    ...
    return render_template("medecin/genres_afficher.html", data=data_genres)
...
"""
    ...
    Remarque :  Dans le champ "name_genre_html" du formulaire "medecin/genres_ajouter.html",
...
"""
    ...
    Test : ex. cliquer sur le menu "medecin" puis cliquer sur le bouton "DELETE" d'un "genre"
...
def genre_delete_wtf():
    ...
    try:
        ...
        if request.method == "GET":
            ...
            # Requête qui affiche tous les facture qui ont le genre que l'utilisateur veut effacer
